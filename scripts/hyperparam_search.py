...
# this script lives in scripts/, so the repository root has to be importable
...
from utils.previous_chapters import GPTModel, create_dataloader_v1
...
if __name__ == "__main__":
    ...
    with open(data_path("the-verdict.txt"), "r", encoding="utf-8") as file:
        text_data = file.read()
